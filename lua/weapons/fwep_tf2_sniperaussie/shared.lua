SWEP.PrintName			= "Australian Sniper Rifle" 
SWEP.Author			= "" -- 
...
SWEP.IronSightsPos = Vector( -8.83, -1, 2 )
SWEP.IronSightsAng = Vector( 1, 0, -184.5 ) 

SWEP.SprintGunPos = Vector(10,-10,-10)
SWEP.SprintGunAng = Vector(-20,45,140)

SWEP.IdleGunPos = Vector(0,0,0)
SWEP.IdleGunAng = Vector(0,0,-180)
...
function SWEP:PrimaryAttack()
	...
	if self.Owner:GetNWBool("isaiming") == true then
		self:ShootBullet( self.Primary.Damage + 20 * chargeup, 1, self.Secondary.Cone )
		maxcharge = CurTime() + 3.3
	else
